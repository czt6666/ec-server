...
public class LicenseExtraParam implements Serializable {
     ...
     * 是否可以通过外部传入
     */
    private static final boolean needIn = false;

    /**
     * 不能外部传入时是否需要认证信息
     */
    private static final boolean needCheck = true;
    ...
    public String toString() {
        return "LicenseExtraParam{" +
                ...
                ", isCpuCheck=" + isCpuCheck +
                ", cpuSerial='" + cpuSerial + '\'' +
                ", isBoardCheck=" + isBoardCheck +
