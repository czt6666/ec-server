...
public class LicenseCustomManager extends LicenseManager {
    ...
    private boolean checkIpAddress(List<String> expectedList, List<String> serverList){
        ...
        serverList.replaceAll(String::toLowerCase);
    ...
    private boolean checkSerial(String expectedSerial, String serverSerial){
        log.debug("" + expectedSerial);
        log.debug("" + serverSerial);
        if(CommonUtils.isNotEmpty(expectedSerial)){
            if(CommonUtils.isNotEmpty(serverSerial)){
                expectedSerial = expectedSerial.toLowerCase();
                serverSerial = serverSerial.toLowerCase();
