...
CREATE TABLE `elderly_service_subject` (
  ...
  `business_address` varchar(500) NOT NULL COMMENT '经营地址',
   registered_lat DECIMAL(10,6) DEFAULT NULL COMMENT '注册地址纬度',
   registered_lng DECIMAL(10,6) DEFAULT NULL COMMENT '注册地址经度',
   business_lat DECIMAL(10,6) DEFAULT NULL COMMENT '经营地址纬度',
   business_lng DECIMAL(10,6) DEFAULT NULL COMMENT '经营地址经度',
  ...
  `service_mode` varchar(200) DEFAULT NULL COMMENT '服务模式，多选逗号分隔（机构住养,日间照料,上门服务等）',
